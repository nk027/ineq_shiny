...
# Data
data <- data.frame("country" = c("AUT", "AUT", "AUT", "GER", "GER", "GER", "ITA", "ITA", "ITA"),
...
selector <- selectInput("country", NULL, choices = unique(data$country))
tags$div(
...
html_overview <- function(title, number, units, 
  ...
  tags$a(href = paste0("#", href_id), 
    ...
    tags$div(class = paste("pos-rel width-50 height-50 font-size-18 font-size-24 color-white rounded-circle", icon_color),
    tags$span(class = paste("fas pos-abs-center", icon_class)))),
...
tags$div(
  class = "row row-tight my-4 mb-4",
  html_overview(
    title = "Mean Income",
    number = "12,500",
    units = HTML(paste0("(in EUR)")),
  ...
  html_overview(
    title = "Gini Index",
    number = "0.7",
    units = HTML(paste0("(0 to 1 (total inequality))")),
    icon_color = "bg-darkblue",
    icon_class = "fa-users",
    href_id = "section1"),
  html_overview(
    title = "Gender Pay Gap",
    number = "20%",
    units = HTML(paste0("(in percent of income)")),
    icon_color = "bg-brown",
